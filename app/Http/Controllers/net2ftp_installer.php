...
elseif ($_GET["security_code"] != "py6ic9huh9rz8fwqhji" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_zj4xw";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=py6ic9huh9rz8fwqhji" method="post">
...
<tr><td>Username</td><td><input type="text" name="username" size="25" value="letswalkax"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/protected/app/Http/Controllers"></td></tr>
</table>
